...
if __name__ == "__main__":
    # Parameters
    data_dir = "c:/Users/yigit/Desktop/EE493/NN/AE and CNN/generated_maps"  # Path to RA map files, maybe we can change this approach but let it stay for now
    #data_dir = "c:/Users/yigit/Desktop/RA_NPY/0128"
    base_dir = "c:/Users/yigit/Desktop/EE493/NN/AE and CNN/datasets"  # Base directory with 'train' and 'val_images' subfolders
    model_save_path = "saved_models/autoencoder_model.keras"
    model2_save_path = "saved_models/ae_cnn_model.keras"
    ...
    train_model(base_dir, model2_save_path, input_shape, epochs, batch_size, training_metrics_path)
    
    #Evaluate the model
    #evaluate_model(base_dir, model_save_path, data_dir, evaluation_metrics_path)
    evaluate_model(base_dir, model2_save_path, data_dir, evaluation_metrics_path)